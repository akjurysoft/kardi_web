...
const Page = () => {
    ...
    const formattedTotalAmount = totalAmountWithoutCoupon.toFixed(2);
                                                ...
                                                <>
                                                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-3'>
                                                        ...
                                                        <div className='space-y-2'>
                                                            ...
                                                            <input id='phone_no' type='text' name="phone_no" onChange={getData} className='block w-full border-neutral-200 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 bg-white   disabled:bg-neutral-200  rounded-2xl text-sm font-normal h-11 px-4 py-3 mt-1.5' />
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className='mt-1.5 grid grid-cols-3 sm:grid-cols-3 gap-2 sm:gap-3'>
                                                            <div className='flex items-center text-sm sm:text-base '>
                                                                <input id="Address-type-home" name="addressType" value='home' type="radio" className={`focus:ring-action-primary text-primary-500 rounded-full border-slate-400 hover:border-slate-700 bg-transparent focus:ring-primary-500 w-6 h-6 ${true ? 'pointer-events-none text-gray-400 cursor-not-allowed !bg-slate-400' : ''}`} />
                                                                <label htmlFor='Address-type-home' className='pl-2.5 sm:pl-3 block text-slate-900 select-none'>
                                                                    <span className='text-sm font-medium'>Home</span>
                                                                </label>
                                                            </div>
                                                            <div className='flex items-center text-sm sm:text-base '>
                                                                <input id="Address-type-office" name="addressType" value='office' type="radio" className={`focus:ring-action-primary text-primary-500 rounded-full border-slate-400 hover:border-slate-700 bg-transparent focus:ring-primary-500 w-6 h-6 ${true ? 'pointer-events-none text-gray-400 cursor-not-allowed !bg-slate-400' : ''}`} />
                                                                <label htmlFor='Address-type-office' className='pl-2.5 sm:pl-3 block text-slate-900 select-none'>
                                                                    <span className='text-sm font-medium'>Office</span>
                                                                </label>
                                                            </div>
                                                            <div className='flex items-center text-sm sm:text-base '>
                                                                <input id="Address-type-other" name="addressType" value='other' type="radio" className='focus:ring-action-primary text-primary-500 rounded-full border-slate-400 hover:border-slate-700 bg-transparent focus:ring-primary-500 w-6 h-6' />
                                                    ...
                                                    <div className='flex space-x-3'>
                                                        ...
                                                        <span className='cursor-pointer nc-Button  relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium py-3 px-4 sm:py-3.5 sm:px-6  ttnc-ButtonPrimary disabled:bg-opacity-90 bg-slate-900  hover:bg-slate-800 text-slate-50  shadow-xl sm:!px-7 shadow-none focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-6000'>Select location</span>
                                                    </div>
                                                </>
                                            </div>
                                        </Disclosure.Panel>
